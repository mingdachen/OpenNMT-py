...
class RNNDecoderBase(nn.Module):
    ...
    def __init__(self, rnn_type, bidirectional_encoder, num_layers,
        ...
        self.attn1 = onmt.modules.GlobalAttention(
        ...
        self.attn3 = onmt.modules.GlobalAttention(
            hidden_size, coverage=coverage_attn,
            attn_type=attn_type
        )
    ...
    def forward(self, tgt, memory_bank1, memory_bank2, memory_bank3,
                state, memory_lengths1=None, memory_lengths2=None,
                memory_lengths3=None, step=None):
        """
        Args:
        ...
        _, memory_batch1, _ = memory_bank1.size()
        _, memory_batch2, _ = memory_bank2.size()
        _, memory_batch3, _ = memory_bank3.size()
        aeq(tgt_batch, memory_batch1)
        aeq(tgt_batch, memory_batch2)
        aeq(tgt_batch, memory_batch3)
        # END

        # Run the forward pass of the RNN.
        decoder_final, decoder_outputs, attns = self._run_forward_pass(
            tgt, memory_bank1, memory_bank2, memory_bank3,
            state, memory_lengths1=memory_lengths1,
            memory_lengths2=memory_lengths2, memory_lengths3=memory_lengths3)
...
class StdRNNDecoder(RNNDecoderBase):
    ...
    def _run_forward_pass(self, tgt, memory_bank1, memory_bank2, memory_bank3,
                          state, memory_lengths1=None,
                          memory_lengths2=None, memory_lengths3=None):
        """
        ...
        decoder_outputs, p_attn = self.attn1(
